...
import {
  ...
  ShoppingBag, CalendarDays, MessageSquare, MapPin, Phone
} from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-sm border-b border-[#CBB89D]/30 p-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 
                className="text-2xl text-[#6B4F37] capitalize"
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="pl-10 pr-4 py-2 border border-[#CBB89D]/30 rounded-lg text-sm focus:outline-none focus:border-[#8DA399] bg-[#FAF7F2]"
                  style={{ fontFamily: 'Inter' }}
                />
              </div>
                ...
                <AnimatePresence>
                  {showNotifications && (
                    <motion.div
                      ...
                      className="absolute right-0 top-12 w-80 bg-white shadow-xl border border-[#CBB89D]/30 rounded-xl p-4 z-50"
                    >
